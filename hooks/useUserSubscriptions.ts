...
/**
 * Mock hook for fetching user subscriptions
 * Replace with actual API call in infrastructure layer
 */
export const useUserSubscriptions = () => {
  const getSubscriptionsForMonth = useCallback((year: number, month: number): Subscription[] => {
  ...
  return { getSubscriptionsForMonth };
};
