...
| 日付       | 変更内容                                                                             |
| ---------- | ------------------------------------------------------------------------------------ |
| 2026-06-26 | `subscription_price_history` 追加（F-03 料金変更の「今月から」対応、`20260626180000`） |
| 2026-06-26 | DAZN「W杯（月額更新）」プラン追加、Gemini の Google AI Plus 料金を ¥725 に更新（`20260626120000`） |
